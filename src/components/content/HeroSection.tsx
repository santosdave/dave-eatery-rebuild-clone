...
export default function HeroSection({ }: Props) {
    return (
        <div className='max-w-[1640] mx-auto p-6 md:px-10'>
            <div className='max-h-[500px] relative overflow-hidden rounded-md'>
                {/* Overlay */}
                <div className='absolute  w-full h-full text-gray-300 max-h-[500px] bg-black/40 flex flex-col items-start justify-center'>
